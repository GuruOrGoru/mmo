...
@onready var _highscores: Highscores = $UI/MarginContainer/VBoxContainer/Highscore
@onready var _return_to_menu: Button = $UI/MarginContainer/VBoxContainer/HBoxContainer/BackButton
@onready var _search_bar: LineEdit = $UI/MarginContainer/VBoxContainer/HBoxContainer/SearchBar
@onready var _search_button: Button = $UI/MarginContainer/VBoxContainer/HBoxContainer/SearchButton
